...
export const seedData = mutation({
    ...
    handler: async (ctx) => {
        ...
        const existingSocialProof = await ctx.db.query("socialProof").first();
        ...
        if (existingVideos && existingSocialProof) {
            return "Data already seeded";
        }

        return "Seed data created successfully: videos and social proof";
    },
});
